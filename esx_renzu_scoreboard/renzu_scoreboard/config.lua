config = {}
config.Mysql = 'mysql-async' -- "ghmattisql", "msyql-async" "oxmysql"
...
config.logo = 'https://forum.cfx.re/uploads/default/original/4X/b/1/9/b196908c7e5dfcd60aa9dca0020119fa55e184cb.png'          -- Logo URL leave blank to delete
